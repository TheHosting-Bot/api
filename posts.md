...
axios
  .get('https://my.thehostingbot.xyz/api/posts')
  .then(response => {
...
/*exemple de réponse dans la console : 

  {
    ...
    "url": "https://my.thehostingbot.xyz/news/spotlight-netheberg",
    ...
    "image": "https://my.thehostingbot.xyz/storage/posts/SX8qh1BqAfJr61AHYPUcFGMRLYNR6SnQzLFW9cir.jpeg"
  },
  {
    "id": 4,
    ...
    "url": "https://my.thehostingbot.xyz/news/ouverture-du-projet-beta",
    ...
    "image": "https://my.thehostingbot.xyz/storage/posts/GCQvkmDJ5y9ut9GCoErfR5qHtyv4c8pt0TbA13Yj.png"
  }
]*/
```
